...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firstname.setText("Rehansh");
        lastname.setText("Roy");
        email.setText("rehanshroy80@gmail.com");
        number.setText("9769786543");
        rollno.setText("15EX8032");
        neareststation.setText("Kanjur");
